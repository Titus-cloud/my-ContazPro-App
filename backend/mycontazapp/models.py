...
#  TODO: create a fn to hundle image for profiles
...
class CustomUserManager(BaseUserManager):
    def creat_user(self, email, password=None, **extras):
        if not email:
...
# TODO: Create a model for subscriptionPlan
...
class UseProfile(models.Model):
    ...
    profile = models.ImageField(upload_to=profile_image, default="profiles/default.png")
...
class Contact(models.Model):
    ...
    date_added = models.DateField(
        auto_now_add=True
    )  # we will addd the exact time such that the user don't
